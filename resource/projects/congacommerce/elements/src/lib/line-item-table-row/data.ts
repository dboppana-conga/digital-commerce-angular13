import { Storefront, Cart, CartItem, AssetLineItemExtended, QuoteLineItem, OrderLineItem } from "@congacommerce/ecommerce";
...
export const value5= new OrderLineItem()
value5.LineNumber=1;
value5.AdjustmentAmount=100;
value5.Quantity=200;
value5.Frequency='17';
value5.Taxable=true;
...
export const subs=[of(1),of(2)] as unknown as any;
