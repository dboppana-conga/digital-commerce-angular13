...
@Component({
  ...
  template: `
    <table class="table table-sm">
      ...
      <tbody>
        <!-- TO Do: when RLP wrapper api available -->
...
export class TabAttachmentsComponent implements OnChanges {
  ...
  getAttachmentUrl(attachmentId, productId) {
   ...
   /**
   * donwloadAttachment method downloads the attachment based on the productInformation object.
   * @param attachment is an object of ProductInformation instance.
   */
